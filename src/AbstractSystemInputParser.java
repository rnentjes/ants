...
public abstract class AbstractSystemInputParser extends AbstractSystemInputReader {
    ...
    public void parseSetup(List<String> input) {
        ...
        for (String line : input) {
            ...
            switch (setupToken) {
                ...
                //case PLAYER_SEED:
                //    player_seed = scanner.nextInt();
                break;
            }
        }
        setup(loadTime, turnTime, rows, cols, turns, viewRadius2, attackRadius2, spawnRadius2, player_seed);
    }
    ...
    public abstract void setup(int loadTime, int turnTime, int rows, int cols, int turns,
            int viewRadius2, int attackRadius2, int spawnRadius2, int player_seed);
